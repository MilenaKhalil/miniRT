...
#define GL_ACTIVE_RElights 0x92F5
...
#define GL_MAX_COMBINED_SHADER_OUTPUT_RElights 0x8F39
...
typedef GLuint (APIENTRYP PFNGLGETDEBUGMESSAGELOGPROC)(GLuint count, GLsizei bufSize, GLenum *lights, GLenum *types, GLuint *ids, GLenum *severities, GLsizei *lengths, GLchar *messageLog);
